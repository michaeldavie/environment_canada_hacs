...
from custom_components.environment_canada.camera import SERVICE_SET_RADAR_TYPE
from custom_components.environment_canada.const import DOMAIN
...
async def test_camera_content_type(
    ...
    await init_integration(hass, ec_data, webp=webp)
...
async def test_set_radar_type_auto(
    ...
    with patch(
        "custom_components.environment_canada.camera.dt_util.now",
